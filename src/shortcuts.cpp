...
static const COMMAND allCommands[] = {
    ...
    {
        "Compile.LoadROM",
        QT_TRANSLATE_NOOP("PZST::Shortcuts", "Compile and load EEPROM"),
        0,
        Qt::Key_F11,
        0
    },
    ...
    {
        "Editor.LineDn",
        QT_TRANSLATE_NOOP("PZST::Shortcuts", "Move down one line"),
        0,
        Qt::Key_Down,
    ...
    {
        "Editor.LineDnExtend",
        QT_TRANSLATE_NOOP("PZST::Shortcuts", "Extend selection down one line"),
        0,
    ...
    {
        "Editor.LineDnScroll",
        QT_TRANSLATE_NOOP("PZST::Shortcuts", "Scroll view down one line"),
        0,
        Qt::Key_Down | Qt::CTRL,
    ...
    },
    {
        ...
        QT_TRANSLATE_NOOP("PZST::Shortcuts", "Extend rectangular selection down one line"),
        0,
    ...
    {
        "Editor.LineUp",
        QT_TRANSLATE_NOOP("PZST::Shortcuts", "Move up one line"),
        0,
        Qt::Key_Up,
    ...
    {
        "Editor.LineUpExtend",
        QT_TRANSLATE_NOOP("PZST::Shortcuts", "Extend selection up one line"),
        0,
        Qt::Key_Up | Qt::SHIFT,
    ...
    {
        "Editor.LineUpScroll",
        QT_TRANSLATE_NOOP("PZST::Shortcuts", "Scroll view up one line"),
        0,
        Qt::Key_Up | Qt::CTRL,
    ...
    },
    {
        ...
        QT_TRANSLATE_NOOP("PZST::Shortcuts", "Extend rectangular selection up one line"),
        0,
    ...
    {
        "Editor.ParUp",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Move up one paragraph"),
        0,
    ...
    {
        "Editor.ParUpExtend",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend selection up one paragraph"),
        0,
    ...
    {
        "Editor.ParDn",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Move down one paragraph"),
        0,
    ...
    {
        "Editor.ParDnExtend",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend selection down one paragraph"),
        0,
    ...
    {
        "Editor.CharLt",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Move left one character"),
        0,
        Qt::Key_Left,
    ...
    {
        "Editor.CharLtExtend",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend selection left one character"),
        0,
    ...
    {
        "Editor.WordLt",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Move left one word"),
        0,
        Qt::Key_Left | Qt::CTRL,
    ...
    {
        "Editor.WordLtExtend",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend selection left one word"),
        0,
    ...
    },
    {
        ...
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend rectangular selection left one character"),
        0,
    ...
    {
        "Editor.CharRt",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Move right one character"),
        0,
        Qt::Key_Right,
    ...
    {
        "Editor.CharRtExtend",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend selection right one character"),
        0,
    ...
    {
        "Editor.WordRt",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Move right one word"),
        0,
    ...
    {
        "Editor.WordRtExtend",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend selection right one word"),
        0,
    ...
    },
    {
        ...
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend rectangular selection right one character"),
        0,
    ...
    {
        "Editor.VisHome",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Move to first visible character in line"),
        0,
        Qt::Key_Home,
    ...
    },
    {
        ...
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend selection to first visible character in line"),
        0,
    ...
    {
        "Editor.TextStart",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Move to start of text"),
        0,
        Qt::Key_Home | Qt::CTRL,
    ...
    },
    {
        ...
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend selection to start of text"),
        0,
    ...
    {
        "Editor.DisplayHome",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Move to start of displayed line"),
        0,
        Qt::Key_Home | Qt::ALT,
    ...
    },
    {
        ...
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend selection to start of line"),
        0,
        0,
    ...
    },
    {
        ...
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend rectangular selection to first visible character in line"),
        0,
    ...
    {
        "Editor.LineEnd",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Move to end of line"),
        0,
        Qt::Key_End,
    ...
    },
    {
        ...
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend selection to end of line"),
        0,
        Qt::Key_End | Qt::SHIFT,
    ...
    {
        "Editor.TextEnd",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Move to end of text"),
        0,
        Qt::Key_End | Qt::CTRL,
    ...
    },
    {
        ...
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend selection to end of text"),
        0,
    ...
    {
        "Editor.DisplayEnd",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Move to end of displayed line"),
        0,
        Qt::Key_End | Qt::ALT,
    ...
    },
    {
        ...
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend selection to end of displayed line"),
        0,
        0,
    ...
    },
    {
        ...
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend rectangular selection to end of line"),
        0,
    ...
    {
        "Editor.PgUp",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Move up one page"),
        0,
        Qt::Key_PageUp,
    ...
    {
        "Editor.PgUpExtend",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend selection up one page"),
        0,
    ...
    },
    {
        ...
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend rectangular selection up one page"),
        0,
    ...
    {
        "Editor.PgDn",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Move down one page"),
        0,
        Qt::Key_PageDown,
    ...
    {
        "Editor.PgDnExtend",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend selection down one page"),
        0,
    ...
    },
    {
        ...
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Extend rectangular selection down one page"),
        0,
    ...
    {
        "Editor.Clear",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Delete current character"),
        0,
        Qt::Key_Delete,
    ...
    {
        "Editor.DelWordRt",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Delete word to right"),
        0,
    ...
    {
        "Editor.DelLineRt",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Delete line to right"),
        0,
    ...
    {
        "Editor.ToggleIns",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Toggle insert/overtype"),
        0,
        Qt::Key_Insert,
    ...
    {
        "Editor.DelBack",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Delete previous character"),
        0,
        Qt::Key_Backspace,
    ...
    {
        "Editor.DelWordLt",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Delete word to left"),
        0,
    ...
    {
        "Editor.DelLineLt",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Delete line to left"),
        0,
    ...
    {
        "Editor.SelectAll",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Select all text"),
        0,
        Qt::Key_A | Qt::CTRL,
    ...
    {
        "Editor.CutLine",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Cut current line"),
        0,
        Qt::Key_L | Qt::CTRL,
    ...
    {
        "Editor.DelLine",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Delete current line"),
        0,
    ...
    {
        "Editor.LineCopy",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Copy current line"),
        0,
    ...
    {
        "Editor.LineSwap",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Swap current and previous lines"),
        0,
        Qt::Key_T | Qt::CTRL,
    ...
    {
        "Editor.DupSel",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Duplicate selection"),
        0,
        Qt::Key_D | Qt::CTRL,
    ...
    {
        "Editor.Lower",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Convert selection to lower case"),
        0,
        Qt::Key_U | Qt::CTRL,
    ...
    {
        "Editor.Upper",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Convert selection to upper case"),
        0,
    ...
    {
        "Editor.Indent",
        QT_TRANSLATE_NOOP("PZST::Shortcuts","Indent"),
        0,
        Qt::Key_Tab,
    ...
    {
        "Editor.Unindent",
        QT_TRANSLATE_NOOP("PZST::Shortcuts", "Unindent"),
        0,
        Qt::Key_Tab | Qt::SHIFT,
...
{
    const QMap<QString, const COMMAND*> & map = Shortcuts::map();
    if (map.contains(name)) return QApplication::translate("PZST::Shortcuts", map[name]->title);
    return QString();
}
